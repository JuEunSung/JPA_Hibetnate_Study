...
public class MemberDao3Test {
  ...
  public void test2select() {
    ...
    Member3 member1 = null;
    Member3 member2 = null;
  ...
  public void test3update() throws Exception {
    ...
    Member3 member1 = memberDao.selectById(member[0].getMemberId());
    Member3 member2 = memberDao.selectById(member[1].getMemberId());
    Member3 member3 = memberDao.selectById(member[2].getMemberId());
